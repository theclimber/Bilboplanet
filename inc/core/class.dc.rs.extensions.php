...
class rsExtPost
{
	...
	*/
	public static function trackbacksActive(&$rs)
	{
		...
		&& $rs->post_open_tb
		&& ($rs->core->blog->settings->trackbacks_ttl == 0 ||
		time()-($rs->core->blog->settings->trackbacks_ttl*86400) < $rs->getTS());
	}
	...
	*/
	...
	/**
	Returns post date formating according ISO 8601 standard.
	...
	*/
	...
	/**
	Returns post date formating according RFC 822.
...
class rsExtComment
{
	...
	*/
	...
	/**
	Returns comment date formating according RFC 822.
