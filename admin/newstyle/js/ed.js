...
var textarea;
var content;
document.write("<link href=\"newstyle/styles.css\" rel=\"stylesheet\" type=\"text/css\">");

function edSimpleToolbar(obj) {
   
	document.write("<img class=\"buttoned\" src=\"newstyle/icons/bold.png\" name=\"btnBold\" onClick=\"doAddTags('<strong>','</strong>','" + obj + "')\">");
	document.write("<img class=\"buttoned\" src=\"newstyle/icons/italic.png\" name=\"btnItalic\" onClick=\"doAddTags('<em>','</em>','" + obj + "')\">");
	document.write("<img class=\"buttoned\" src=\"newstyle/icons/underline.png\" name=\"btnUnderline\" onClick=\"doAddTags('<u>','</u>','" + obj + "')\">");
	document.write("<img class=\"buttoned\" src=\"newstyle/icons/ordered.png\" name=\"btnList\" onClick=\"doList('<ol>','</ol>','" + obj + "')\">");
	document.write("<img class=\"buttoned\" src=\"newstyle/icons/list.png\" name=\"btnList\" onClick=\"doList('<ul>','</ul>','" + obj + "')\">");
	document.write("<img class=\"buttoned\" src=\"newstyle/icons/quote.png\" name=\"btnQuote\" onClick=\"doAddTags('<blockquote>','</blockquote>','" + obj + "')\">"); 
  	document.write("<img class=\"buttoned\" src=\"newstyle/icons/code.png\" name=\"btnCode\" onClick=\"doAddTags('<code>','</code>','" + obj + "')\">");
	document.write("<br>");
